            ...
            do
            {
                ...
                for (int index = 0; index < static_cast<int>(scenarioEntity.size()); index++)
                {
                    ...
                    for (int i = 0; i < Object::VehicleLightType::NUMBER_OF_VEHICLE_LIGHTS; i++)
                    {
                        ...
                        // printf("emission[%d]: %.2f %.2f %.2f\n",i, vehicleLightActionStatusList[i].emissionRgb[0],
                        // vehicleLightActionStatusList[i].emissionRgb[1], vehicleLightActionStatusList[i].emissionRgb[2]); printf("diffuse[%d]: %.2f
                        // %.2f %.2f\n",i, vehicleLightActionStatusList[i].diffuseRgb[0], vehicleLightActionStatusList[i].diffuseRgb[1],
                        // vehicleLightActionStatusList[i].diffuseRgb[2]);
                    }
